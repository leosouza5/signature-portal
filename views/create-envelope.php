...
<form action="/envelopes" method="post" enctype="multipart/form-data" class="new-document-form">
        ...
        <section class="new-document-card">
            ...
            <label class="new-document-field">
                ...
                <span class="upload-dropzone" id="upload-dropzone">
                    ...
                    <input type="file" name="documents[]" multiple required accept="application/pdf" id="documents-input">
                </span>
                <ul class="selected-files" id="selected-files"></ul>
                <p class="upload-error" id="upload-error"></p>
                <?php old_array('file_names'); // limpa sessao ?>
<small>Apenas arquivos PDF. Limite total do envio: 8MB.</small>
            </label>
        </section>
    ...
    <aside class="new-document-summary">
        ...
        <div class="summary-item">
            ...
            <div><span>Arquivos selecionados</span><strong id="document-count">0</strong></div>
        </div>
        <div class="summary-item">
